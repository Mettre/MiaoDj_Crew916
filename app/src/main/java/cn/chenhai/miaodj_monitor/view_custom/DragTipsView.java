...
public class DragTipsView extends FrameLayout {
    ...
    public DragTipsView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();
    }

    public DragTipsView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void attach(final View attachView, final ViewCreator<View> copyViewCreator, final DragListener dragListener) {
        ...
        attachView.setOnTouchListener(new OnTouchListener() {
            protected void init() {
                ...
                DragTipsView.this.getLocationOnScreen(thisLocation);
                ...
                DragTipsView.this.addView(tipImageView);
            ...
            protected void destory() {
                DragTipsView.this.removeView(tipImageView);
            }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    DragTipsView.this.getLocationOnScreen(location);
     ...
     * 用于页面复用管理
     */
    private static WeakReference<DragTipsView> instance;
    public static DragTipsView create(final Activity activity) {
        if(instance!=null && instance.get()!=null && instance.get().getTag() == activity){
            return instance.get();
        }
        instance = new WeakReference<>(new DragTipsView(activity));
