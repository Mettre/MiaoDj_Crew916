...
/**
 * Created by ChenHai--霜华 on 2016/5/23. 07:44
 * 邮箱：248866527@qq.com
 */
public class CollectUtils {
    ...
    /**
     * void initialize(Application app)     在Application的OnCreate里面初始化
     * */
    ...
    /**
     * void setDebug(boolean isDebug,String TAG)    最好这样写JUtils.setDebug(BuildConfig.DEBUG, "DefaultTag");
     * */
    public static void setDebug(boolean isDebug,String TAG){
        CollectUtils.TAG = TAG;
        CollectUtils.DEBUG = isDebug;
    }
