...
//        if(temType==0 || temType ==1){
//            mGameType = temType;
//        }
//    }
    public int getGameType(){

        TypedArray typedArray = mContext.obtainStyledAttributes(mAttrs, R.styleable.FunGameHeader);
        mGameType = typedArray.getInt(R.styleable.FunGameHeader_game_type, FunGameFactory.HITBLOCK);
        typedArray.recycle();
    ...
    private void initView(AttributeSet attrs) {
        ...
        topMaskView = createMaskTextView("下拉刷新并开始游戏!", 16, Gravity.BOTTOM);
        bottomMaskView = createMaskTextView("Scroll to move handle", 14, Gravity.TOP);
    ...
    private TextView createMaskTextView(String text, int textSize, int gravity) {
        ...
        maskTextView.setTextColor(Color.WHITE);
        //maskTextView.setBackgroundColor(Color.WHITE);
        maskTextView.setBackgroundColor(Color.parseColor("#ff6600"));
