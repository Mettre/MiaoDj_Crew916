package cn.chenhai.miaodj_monitor.FunRefresh;
...
/**
 * Created by ChenHai--霜华 on 2016/6/13. 17:11
 * 邮箱：248866527@qq.com
 */
public class FunGameRefreshRecyclerView extends LinearLayout implements View.OnTouchListener {
    /**
     * 下拉状态
     */
    ...
    public FunGameRefreshRecyclerView(Context context) {
        this(context, null);
    }

    public FunGameRefreshRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FunGameRefreshRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    //自由设置游戏类型，暂定hit_block ：0  和  battle_city ：1
//    public void setGameType(int temType){
//        header.setGameType(temType);
////        removeView(header);
////        header = new FunGameHeader(mContext, mAttrs);
////        addView(header, 0);
//    }
    ...
    private void checkAblePull(MotionEvent event) {
        ...
        if (firstChild != null) {
            LinearLayoutManager temManager = (LinearLayoutManager) recyclerView.getLayoutManager();
            int firstVisiblePos = temManager.findFirstVisibleItemPosition();
            //int firstVisiblePos = recyclerView.getFirstVisiblePosition();
            int b = firstChild.getTop();
