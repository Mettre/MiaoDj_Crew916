package cn.chenhai.miaodj_monitor.views.preview;
...
public class FiveGridView extends ViewGroup {
    ...
    private FiveGridViewAdapter mAdapter;

    public FiveGridView(Context context) {
        this(context, null);
    }

    public FiveGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FiveGridView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                gridWidth = gridHeight = (totalWidth - gridSpacing * (columnCount - 1)) / columnCount;
    ...
    /** 设置适配器 */
    public void setAdapter(@NonNull FiveGridViewAdapter adapter) {
        mAdapter = adapter;
        ...
        if (adapter.getImageInfo().size() > maxImageSize) {
            ...
            if (child instanceof FiveGridViewWrapper) {
                FiveGridViewWrapper imageView = (FiveGridViewWrapper) child;
        ...
        if (position < imageViews.size()) {
            ...
            imageView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mAdapter.onImageItemClick(getContext(), FiveGridView.this, position, mAdapter.getImageInfo());
                }
            });
