...
public class FiveGridViewWrapper extends ImageView {
    ...
    public FiveGridViewWrapper(Context context) {
        this(context, null);
    }

    public FiveGridViewWrapper(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FiveGridViewWrapper(Context context, AttributeSet attrs, int defStyleAttr) {
