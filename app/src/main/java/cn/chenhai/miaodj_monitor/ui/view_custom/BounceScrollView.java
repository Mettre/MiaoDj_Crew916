...
/**
 * Created by ChenHai--霜华 on 2016/6/8. 18:02
 * 邮箱：248866527@qq.com
 */
...
//                + "," + normal.bottom);
    ...
    public boolean isNeedMove() {
        int l1 = inner.getMeasuredHeight();
        int l2 = getHeight();
...
//        Log.e("jj", "scrolly=" + scrollY);
        ...
        /**经调试 底部时，总是scrollY 比 offset 多72，可能是CardView特性问题，待以后有空祥查*/
        if (scrollY == 0 || scrollY == offset + 12) {
            return true;
        }
        return false;
    }
